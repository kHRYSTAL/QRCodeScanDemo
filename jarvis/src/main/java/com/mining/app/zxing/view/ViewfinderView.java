...
import com.shandianshua.jarvis.R;
...
public final class ViewfinderView extends View {
  ...
  public void onDraw(Canvas canvas) {
    ...
    if (resultBitmap != null) {
      ...
      lineRect.bottom = slideTop + 30;
      if (((BitmapDrawable) (getResources().getDrawable(R.mipmap.sds_qr_line))) != null) {
        canvas.drawBitmap(
            ((BitmapDrawable) (getResources().getDrawable(R.mipmap.sds_qr_line))).getBitmap(), null,
            lineRect, paint);
      }
